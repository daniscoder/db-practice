...
| `task-2-schema/screenshots/` | Снимок успешного развертывания |
...
| `task-3-etl/partners_clean.csv` | Очищенные партнеры |
...
![Партнеры с числом доставок](task-4-queries/screenshots/partners-with-counts.png)
