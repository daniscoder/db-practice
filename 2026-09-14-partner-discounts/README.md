...
| Задание | Файлы |
|---|---|
| 1. Расчет скидки | `app/discount.py`, `tests/test_discount.py` |
...
Код лежит одной программой в `app/`, а не по папкам `task-N`: здесь задания - это
этапы одного приложения, и модули импортируют друг друга.
...
`discount.py` - 100% и по строкам, и по ветвлениям.
...
![Окно с данными из тестовой базы](screenshots/app-window.png)

Снимок отрисован самой программой по тестовой базе, поэтому без рамки окна.
